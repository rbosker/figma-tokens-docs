...
#### Creating a folder structure of sets
You can create a folder structure from the plugin. Simply rename token sets into folder/file structures, by giving them a name separated by a '/'. Example: try naming a token set 'base/colors' to have nested sets.
